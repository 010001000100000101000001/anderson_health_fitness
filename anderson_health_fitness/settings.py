...
CSRF_TRUSTED_ORIGINS = [
    'https://8000-01000100010-andersonhea-0xa2lsw1mgo.ws.codeinstitute-ide.net',
...
ROOT_URLCONF = 'anderson_health_fitness.urls'
...
WSGI_APPLICATION = 'anderson_health_fitness.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'anderson-health-fitness'
